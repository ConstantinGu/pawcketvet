  ...
  return (
    <>
      <div style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ color: '#A1887F', fontSize: '1.05rem' }}>Gérez les prescriptions médicales</p>
      </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <div>
                      ...
                      <p style={{ color: '#A1887F', fontSize: '0.85rem', marginTop: '0.25rem' }}>
                        {p.dosage} | {p.frequency} | {p.duration}
                      </p>
                      {p.instructions && <p style={{ color: '#A1887F', fontSize: '0.85rem', fontStyle: 'italic', marginTop: '0.25rem' }}>{p.instructions}</p>}
                      <p style={{ color: '#A1887F', fontSize: '0.8rem', marginTop: '0.25rem' }}>
